...
void breadth_first_visit(const IncidenceGraph& g, SourceIterator src_begin,
    SourceIterator src_end, Buffer& Q, BFSVisitor vis, ColorMap color)
{
    ...
    for (; src_begin != src_end; ++sources_begin)
    {

...
#include <boost/log/src/severity_logger.hpp>
#include <boost/log/src/record_ostream.hpp>
...
typedef src::severity_logger_mt< severity_level > logger_type;
#else
typedef src::severity_logger< severity_level > logger_type;
#endif
